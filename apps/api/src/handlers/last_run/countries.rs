...
#[utoipa::path(
    ...
    description = "Return verified-node country distribution from the newest run that matches the phase filter. Defaults to the latest finished run. Use phase=any for live globe views that should include crawling or draining runs.",
    params(
