...
#[utoipa::path(
    ...
    description = "Return verified-node start-height distribution from the newest run that matches the phase filter. Defaults to the latest finished run.",
    params(
