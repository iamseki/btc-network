...
| `BNDD-0002` | `Benchmarking analytics storage for crawler observations` | `revised` | [BNDD-0002/BNDD-0002.md](./BNDD-0002/BNDD-0002.md) |
| `BNDD-0003` | `Web and future API deployment strategy` | `proposed` | [BNDD-0003/BNDD-0003.md](./BNDD-0003/BNDD-0003.md) |
