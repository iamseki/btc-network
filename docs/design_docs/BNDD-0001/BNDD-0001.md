...
| Related docs | [Architecture Decisions](../../agents/architecture-decisions.md), [Frontend Architecture](../../agents/frontend-architecture.md) |
...
1. **Protocol-first Bitcoin networking in Rust**
   ...
   - expose them through a shared Rust library, CLI flows, crawler, desktop shell, and web UI
