...
| --- | --- | --- | --- | --- |
| Phase 1: Shared analytics contract and API app | `reviewing` | `2026-03-30` | `PR #16` | `Shared crawler analytics read models, the ClickHouse-backed reader, the new Axum API app, and the initial public-read hardening layer are on [PR #16](https://github.com/iamseki/btc-network/pull/16).` |
| Phase 2: Web and desktop analytics UI wiring | `reviewing` | `2026-03-30` | `PR #16` | `The web shell now includes analytics-first pages, page-level secondary navigation, and the shared HTTP analytics helper used by both web and desktop on [PR #16](https://github.com/iamseki/btc-network/pull/16).` |
