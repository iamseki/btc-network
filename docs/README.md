...
Start here if you need repository documentation and do not yet know which document is relevant.
...
- `Frontend UI or navigation task`
  - [Agent Docs Index](./agents/README.md)
  - [Frontend Architecture](./agents/frontend-architecture.md)
- `Rust protocol or session task`
  - [Agent Docs Index](./agents/README.md)
  - [Architecture Decisions](./agents/architecture-decisions.md)
- `Desktop bridge task`
  - [Agent Docs Index](./agents/README.md)
...
- `project and architecture guidance`
  - [Architecture Decisions](./agents/architecture-decisions.md)
  - [Frontend Architecture](./agents/frontend-architecture.md)
